...
public class ItemTypeImage {
    ...
    public static int typeACImage(Integer type) {
        ...
        case 5:
            return R.drawable.type_game;
        case 6:
            return R.drawable.type_money;
        default:
    ...
    public static int typeGridImage(Integer type) {
        switch (type) {
        case 1:
            return R.drawable.type_grid_cd;
        case 2:
            return R.drawable.type_grid_dvd;
        case 3:
            return R.drawable.type_grid_bluray;
        case 4:
            return R.drawable.type_grid_book;
        case 5:
            return R.drawable.type_grid_game;
        case 6:
            return R.drawable.type_grid_money;
        default:
            return R.drawable.type_grid_default;
        }
    }
}